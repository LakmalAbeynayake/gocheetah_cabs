...
class category_model extends CI_Model
{
    ...
    function getSubCategoryPrint()
    {
        ...
        $this->db->join('product_category c', 'c.cat_id = s.cat_id', 'left');
        $query = $this->db->get();
        if ($query->num_rows() > 0) {
            return $query->result();
        } else {
    ...
    function category_update($category_tbl_id = '', $cat_id = '', $cat_name = '', $imgName = '', $imageThumb = '', $sts = '', $web_display_name = '', $web_icon = '', $show_web = '')
    {
        $data1 = array(
            'cat_code' => $cat_id,
            'cat_name' => $cat_name,
