												...
												<table id="data_table" class="table table-striped table-bordered table-hover" style="width:100%">
													...
													<tbody>
														...
														foreach ($perm_and_page_list as $row) {
															$has_permission = $this->common_model->check_permission($row['menu_id'], $user_group_id, 1);
														?>
															<tr>
																<td> 
																	<span class="<?php echo $row['menu_parent_id'] > 0 ? "tab-right" : ""; ?>">
																		<?php echo $row['menu_display_name'] ?>
																	</span>
																</td>
																<td class="text-center">
																	<label class="">
																		<input type="checkbox" class="square-teal" value="1" <?php if ($has_permission) echo 'checked="checked"'; ?> name="row_view_<?php echo $row['menu_id']; ?>">
																	</label>
																</td>
															</tr>
														<?php } ?>
