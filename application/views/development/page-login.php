						...
						<div class="content">
							...
							<form class="form-auth-small" action="" id="login-form">
								...
								<div class="form-group">
									<label for="user_username" class="control-label sr-only">Email</label>
									<input type="" class="form-control" id="user_username" value="lakmal" placeholder="Email" required>
								</div>
								<div class="form-group">
									<label for="user_password" class="control-label sr-only">Password</label>
									<input type="password" class="form-control" id="user_password" value="demo1234" placeholder="Password" required>
								</div>
