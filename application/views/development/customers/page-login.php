						...
						<div class="content">
							...
							<form class="form-auth-small" action="" id="login-form">
								...
								<div class="bottom">
									...
									<span class="helper-text" style="text-decoration: underline ;"><i class="fa fa-user"></i> <a href="<?php echo base_url() ?>customers/reg">Create an account</a></span>
								</div>
							</form>
						</div>
					</div>
			...
			$.ajax({
				...
				success: function(data) {
					if (!data.success) {
						...
						setTimeout(() => {
							window.location.href = "<?php echo base_url('newjourney') ?>";
						}, 1000);
					}
				},
				error: function(data) {
